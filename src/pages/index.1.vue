<template>
    <div class="wrap">
        ...
        <!-- <popup class="new-more-handle-box" v-model="showMore" :is-transparent="true" :show-mask="false" @on-show="zIndex = 500" @on-hide="zIndex = -1">
            <div class="new-more-handle">
                <div class="handle-item handle-item1">服务</div>
                <div class="handle-item handle-item2">炫技</div>
                <div class="handle-item handle-item3">文章</div>
                <div class="handle-item handle-item4">需求</div>
                <div class="handle-item5">拍摄</div>
            </div>
        </popup> -->
